...
export const JulyNoise = returnArrThing(June2021Concerns,"Noise/Party").concat(returnArrThing(June2021Concerns,"Spa after 10pm"))
export const JulyParking = returnArrThing(June2021Concerns,"Parking")
export const JulyOccupancy = returnArrThing(June2021Concerns,"Over Occupancy")
export const JulyLicense = returnArrThing(June2021Concerns,"No License")
export const JulyCheckIn = returnArrThing(June2021Concerns,"No In-person Check-in")
export const JulyOther = returnArrThing(June2021Concerns,"Delinquent TOT")
export const JulyTotalFines = totalFines(June2021Concerns)