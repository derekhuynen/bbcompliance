...
import {AllData, UniqueHeaders} from "../components/Stats";
...
const basicHeaders = [{key: "DateEntered", value: "Data"}, {
    key: "Disposition",
    value: "Disposition"
}, {key: "ConcernAddress", value: "Address"}, {key: "ConcernType", value: "Complaint"}, {
    key: "CitationFineTotal",
    value: "Fine"
}];
const AllMonth = [{key: "All", value: AllData}, {key: "February", value: February2021}, {
    key: "March",
    value: March2021
}, {key: "April", value: April2021}, {key: "June", value: June2021}, {key: "July", value: July2021}, {
    key: "August",
    value: August2021
}]
        ...
        <div className={"page-container"}>
            ...
            <div className={"drop_down_container"}>
                ...
                <div className={"drop-down-data"}>
                    ...
                    <DropDown menu={[{key: "All", value: "All"}, {key: "Yes", value: "Yes"}, {key: "No", value: "No"}]}
                              setTopic={setFine} placeholder={fine}/>
                </div>
            </div>
